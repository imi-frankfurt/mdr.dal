...
public class GetNamespaceScopedIdentifierByUrn extends AbstractRoutine<ScopedIdentifierRecord> {
    ...
    private static final long serialVersionUID = -736549750;
    ...
    public GetNamespaceScopedIdentifierByUrn() {
        super("get_namespace_scoped_identifier_by_urn", Public.PUBLIC, de.mig.mdr.dal.jooq.tables.ScopedIdentifier.SCOPED_IDENTIFIER.getDataType());
