...
public class GetElementByUrn extends AbstractRoutine<ElementRecord> {
    ...
    private static final long serialVersionUID = 1828643279;

    /**
     * The parameter <code>public.get_element_by_urn.RETURN_VALUE</code>.
     */
    public static final Parameter<ElementRecord> RETURN_VALUE = Internal.createParameter("RETURN_VALUE", de.mig.mdr.dal.jooq.tables.Element.ELEMENT.getDataType(), false, false);
    ...
    public GetElementByUrn() {
        super("get_element_by_urn", Public.PUBLIC, de.mig.mdr.dal.jooq.tables.Element.ELEMENT.getDataType());
